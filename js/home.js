...
function renderHome() {
    ...
    if (finalCta && homeData.finalCta) {
      ...
      <a href="/pages/contacto.html" class="btn btn-secondary btn-lg">${homeData.finalCta.button}</a>
    `;
    }
}
    ...
    servicesGrid.innerHTML = serviciosData.servicios
      ...
      <div class="service-card">
        ...
        <div class="service-content">
          ...
          <a href="/pages/servicios.html#${service.id}" class="btn btn-primary btn-sm">Conocer más</a>
        </div>
      </div>
    `)
        .join('');
